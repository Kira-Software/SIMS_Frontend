...
import { submitregrading ,getinstructorregrading} from "../Redux/Action/regrading";
...
const Instructorgrade = ({
  ...
  const handlesubmit = (Year, Semister, Section, Department, Coursename) => {
    ...
    submitregrading(Year, Semister, Section, Department, Coursename);
