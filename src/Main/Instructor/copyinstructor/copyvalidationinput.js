...
const Instructorgrade = ({
  ...
  const handlemarkchange = (e, Applicationid) => {
    ...
    // console.log(
    //   "the value of lengths respectively are ",
    //   quizlength,
    //   assignmentlength,
    //   projectlength,
    //   attendancelength
    ...
    for (i = 0; i < studentscourseregistered.length; i++) {
      for (j = 0; j <= temparr2.length + 1; j++) {
        ...
        if (j < quizlength.length) {
          if (
            e.target.value < quizlength[j] ||
            e.target.value > quizlength[j]
          ) {
        ...
        // } else if (j <= quizlength.length + assignmentlength.length) {
        // } else if (
        //   j <=
        //   quizlength.length + assignmentlength.length + projectlength.length
        // ) {
        // } else if (
        //   j <=
        //   quizlength.length +
                ...
                <thead>
                  <tr>
                    ...
                    {instructorassessment.map((item, idx) => {
                      ...
                      // quizlength = item.Quiz.length
                      // assignmentlength = item.Assignment.length
                      // projectlength = item.Project.length
                      // attendancelength = item.Attendance.length
